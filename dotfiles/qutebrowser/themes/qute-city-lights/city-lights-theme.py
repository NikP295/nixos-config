clr = {
    ...
    "fg-disabled": "#1A7F73", #fg-disabled
    "fg": "#2B9E87", #base05 (white-ish, cadet-blue-crayola)
    # "cbc-alt": "#9CAABB", # base08 (white-ish, cadet-blue alt)
    # "fg-alt": "#728ca0", #base06 (bright white, light-slate-gray)
    "m&aya-blue": "#5ec4ff", # blue
    ...
    "d&ark-cyan": "#008b94", # dark cyan
    "c&ornflower-blue": "#539AFC", # bright blue
